...
import (
	"E-commerce_system/product/internal/config"
	"E-commerce_system/product/internal/middleware"
	"fmt"
...
type ServiceContext struct {
	...
	JwtAuth *middleware.ProjwtAuthMiddleware
...
func NewServiceContext(c config.Config) *ServiceContext {
	return &ServiceContext{
		Config:  c,
		JwtAuth: middleware.NewProjwtAuthMiddleware(),
		DB:      MysqlConn(c),
		Redis:   RedisConn(c),
	}
}
